...
class Colors {
  Color _mainColor = Color(0xffEC7063);
  Color _mainDarkColor = Color(0xffCB4335);
  Color _secondColor = Color(0xffEC7063);
  Color _secondDarkColor = Color(0xFFEDE7F6);
  Color _accentColor = Color(0xffF5B7B1);
  Color _accentDarkColor = Color(0xffF5B7B1);
